...
unsigned int BranchHis = 0;
unsigned int BranchHisLen = 12;
unsigned int BranchTable[4096];
...
bool BTB_prediction(ADDRINT ins_ptr)
{
    ...
    unsigned int predict = BranchTable[(BTB[index].BranchHistory & 0xFF)];
...
VOID BTB_update(ADDRINT ins_ptr, bool taken)
{
    ...
    index = mask & ins_ptr;
...

        {
                ...
                if (BranchTable[BTB[index].BranchHistory] >= 3)

                {

                        BranchTable[BTB[index].BranchHistory] = 3;
...

                {
                	...
                	BranchTable[BTB[index].BranchHistory]++;
...

        {
                ...
                if (BranchTable[BTB[index].BranchHistory] <= 0)

                {

                        BranchTable[BTB[index].BranchHistory] = 0;
